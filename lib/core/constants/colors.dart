...
class JColor {
  ...
  // App Basic Colors
  static const Color primary = Color(0xfff4f2f0);
  static const Color secondary = Color(0xFFc8d7d2);
  static const Color accent = Color(0xFFd84339);
...
// Graph Colors
  ...
  static const Gradient gradientBgTile = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [
...
// ------------------ Colors From TT ------------------
  ...
  // Button colors
  static const Color buttonPrimary = Color(0xffd84339);
  static const Color buttonSecondary = Color(0xFFc8d7d2);
  ...
  // Neutral Shades
  static const Color black = Color(0xFF373234);
